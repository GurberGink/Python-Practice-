...
num = int(
    input(
        "Please provide a number, I will tell you whether that number is even or odd. "
    )
)
if num % 2 == 0:
    print("Even")
...
print(
    "With these two values I will calculate whether they can be divided equally or not."
)
sleep(3)
os.system("clear")
