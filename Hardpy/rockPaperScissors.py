...
print("I see you'd like to play Rock, Paper, Scissors. \nThis a two player game requiring a single decision from each player each round. ")

sleep(5)
os.system("clear")

while status:
    player1 = str(input("Player One, please choose: Rock|Paper|Scissors \n\n")).capitalize()
    sleep(0.5)
    ...
    player2 = str(input("Player Two, please choose: Rock|Paper|Scissors \n\n")).capitalize()
    sleep(0.5)
    ...
    if player1 == player2:
        ...
        print("Player Two wins by choice of " + player2 + " where Player One chose " + player1 + "!\n")
        
    elif player1 == decisions[0] and player2 == decisions[2]:
        print("Player One wins by choice of " + player1 + " where Player Two chose " + player2 + "!\n")
